            ...
            <?php foreach ($referentiels as $ref): ?>
                <div class="card">
                    ...
                    <div class="card-content">
                        <h3 class="card-title">
                            <a href="?page=apprenants&classe_filter=<?= $ref['id'] ?>">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="card-learners">
                            <a href="?page=apprenants&classe_filter=<?= $ref['id'] ?>" class="view-learners-link">
                                Voir les <?= count($ref['apprenants'] ?? []) ?> apprenants
                            </a>
                        </div>
                    </div>
                </div>
